...
> `✅ AGENTS.md lu en entier (N l., 18 règles R1→R18) + architecture/README.md (M l.)`
...
**Frontend yaammoo** : avant de travailler sur intégration frontend-backend, lire `../../yaammoo/AGENTS.md`.
...
> Règle identique côté **frontend** (`yaammoo/AGENTS.md`, R15).
