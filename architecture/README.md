...
| [pricing-margin-risk.md](./pricing-margin-risk.md)       | **Risque de marge** — pourquoi le plafond vaut 1400, balayage exhaustif, pertes acceptées, table pour relever le plafond                                    | ✅     |
