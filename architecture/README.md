...
| [notifications.md](./notifications.md)                   | Notifications — FCM/APNs/Expo dispatcher, image, routes `/notification`, stockage Supabase                                                                  | ✅     |
| [notifications-broadcast.md](./notifications-broadcast.md) | **Notifications boutique** — plans (`settings_notification`), quota atomique, audiences clients / ville / tous, diffusion asynchrone                     | ✅     |
| [user-location.md](./user-location.md)                   | **Localisation des users** — `POST /user/location`, tout dans `user_locations` (rien sur `users`), capture app fermée                                          | ✅     |
