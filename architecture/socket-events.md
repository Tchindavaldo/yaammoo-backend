...
| `fastFoodOrderUpdated`  | `userId` marchand              | `updateOrders.service.js`                                   | `{ data: order }` — **vue marchand** (prix réels + `customerTotal`, cf. [pricing-roles.md](./pricing-roles.md#ce-que-chaque-rôle-voit)) |
